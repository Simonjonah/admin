        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span class="d-none d-md-inline">{{ !Auth::guest() && Auth::user()->name }}</span>
                </a>
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <li class="user-header bg-primary">
                        <img src="/photos/logo.jpg"
                             ...
                             alt="User Image">
                        <p>
                            {{ !Auth::guest() && Auth::user()->name }}
                            <small>Member since {{ !Auth::guest() && Auth::user()->created_at->format('M. Y') }}</small>
                        </p>
                    </li>
                    <!-- Menu Footer-->
...
<!-- Content Wrapper. Contains page content -->
    ...
    <footer class="main-footer">
        ...
        <strong>
           Copyright &copy; 2022<a href="https://hometeacher.ng">Hometeacher.ng</a>.
        </strong>
        All rights reserved.
    </footer>
</div>
