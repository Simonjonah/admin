			...
			{{-- <div class="sec-title-three">
				<div class="clearfix">
					...
					<div class="pull-right">
						<div class="text">Enroll for our home teaching without regrete</div>
					</div>
				</div>
			</div> --}}
			...
			<div class="row clearfix">
				...
				<div class="news-block-two red col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<h5><a href="primary1">Primay 1/Preperatory 1</a></h5>
							<a href="primary1" class="theme-btn btn-style-fourteen">View</a>
						</div>
					</div>
				</div>
				...
				<div class="news-block-two red col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							...
							<h5><a href="primary2">Primay 2/Grade 1</a></h5>
							<a href="primary2" class="theme-btn btn-style-fourteen">View</a>
						</div>
					</div>
				</div>
				...
				<div class="news-block-two red col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							...
							<h5><a href="primary3">Primay 3/Grade 2</a></h5>
							
							<a href="primary3" class="theme-btn btn-style-fourteen">View</a>
						</div>
					</div>
				</div>
				...
				<div class="news-block-two red col-lg-4 col-md-6 col-sm-12" style="margin-top: 30px">
					<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							...
							<h5><a href="primary4">Primay 4/Grade 3</a></h5>
							
							<a href="primary4" class="theme-btn btn-style-fourteen">View</a>
						</div>
					</div>
				</div>
				...
				<div class="news-block-two red col-lg-4 col-md-6 col-sm-12" style="margin-top: 30px">
					<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<h5><a href="primary5">Primay 5/Grade 4</a></h5>
							<a href="primary5" class="theme-btn btn-style-fourteen">View</a>
						</div>
					</div>
				</div>
				...
				<div class="news-block-two red col-lg-4 col-md-6 col-sm-12" style="margin-top: 30px">
					<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<h5><a href="primary6">Primay 6/Grade 5</a></h5>
							<a href="primary6" class="theme-btn btn-style-fourteen">View</a>
						</div>
					</div>
				</div>
