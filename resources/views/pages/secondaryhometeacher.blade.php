				...
				<div class="news-block-two red col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							<ul class="post-meta">
								<li><span class="fa fa-calendar"></span>monday, feb, 2022</li>
								<li><span class="fa fa-user"></span>Coming Soon</li>
							</ul>
							<h5><a href="#">JSS 1</a></h5>
							<h5><a href="#">Basics Science</a></h5>
							<a href="#" class="theme-btn btn-style-fourteen">Buy</a>
						</div>
					</div>
				</div>
				...
				<div class="news-block-two red col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-content">
							...
							<h5><a href="#">JSS 2</a></h5>
							<h5><a href="#">English Language</a></h5>
							<a href="#" class="theme-btn btn-style-fourteen">Buy</a>
						</div>
					</div>
				</div>
				...
				<div class="news-block-two red col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="image">
							<img style="height: 250px;" src="images/resource/teach1.jpg" alt="" />
							<div class="overlay-box">
								<a href="images/resource/teach1.jpeg" data-fancybox="news" data-caption="" class="plus flaticon-plus-symbol"></a>
							</div>
						</div>
						<div class="lower-content">
							<ul class="post-meta">
