          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">{{ Auth::guard('marketer')->user()->firstname }} {{ Auth::guard('marketer')->user()->lastname }}</h3>

                <p class="text-muted text-center">Marketer</p>

                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Buyers</b> <a class="float-right">{{ $buyer_counts }}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Withdrawals</b> <a class="float-right">₦ {{ $marketerwithdrawalshare_counts }}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Wallets</b> <a class="float-right">₦ {{ $marketershare_counts}}</a>
                  </li>
                </ul>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">
                  <a href="{{  Auth::guard('marketer')->user()->referral_link }}">{{ Auth::guard('marketer')->user()->referral_link}}</a>
                </p>
                ...
                <p class="text-muted">{{ Auth::guard('marketer')->user()->email }}</p>
                ...
                <p class="text-muted">
                  {{ Auth::guard('marketer')->user()->phone }}
                </p>
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="firstname" class="form-control" value="{{ Auth::guard('marketer')->user()->firstname }}" id="inputName" placeholder="Name">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Lastname</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="lastname" value="{{ Auth::guard('marketer')->user()->lastname }}" id="inputEmail" placeholder="Last Name">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Email</label>
                        <div class="col-sm-10">
                          <input type="email"  name="email" value="{{ Auth::guard('marketer')->user()->email }}" disabled class="form-control" id="inputEmail" placeholder="Email">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="number" name="phone" value="{{ Auth::guard('marketer')->user()->phone }}" class="form-control" id="inputName2" placeholder="Phone">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputExperience" class="col-sm-2 col-form-label">Gender</label>
                        <div class="col-sm-10">
                          <input type="text" name="phone" value="{{ Auth::guard('marketer')->user()->gender }}" class="form-control" id="inputName2" placeholder="Gender">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputSkills" class="col-sm-2 col-form-label">Address</label>
                        <div class="col-sm-10">
                          <input type="text" name="address" value="{{ Auth::guard('marketer')->user()->address }}"  class="form-control" id="inputSkills" placeholder="Address">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="file" name="images" value="{{ Auth::guard('marketer')->user()->address }}"  class="form-control" id="inputSkills" placeholder="Address">
                        </div>
                      </div>
