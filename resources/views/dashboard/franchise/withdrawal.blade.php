  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-info">Request for Widthdrawal by {{ Auth::guard('franchise')->user()->name }}</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="tab-pane" id="settings">
                    <form action="{{ route('franchise.createwithdrawal') }}" method="post">
                        @csrf
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          ...
                          value="{{ old('account_name') }}" id="inputName" placeholder="Account Name" @error('account_name') is-invalid @enderror"
                          >
                        </div>
                        @error('account_name')
                      ...
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Account Name</label>
                        <div class="col-sm-10">
                          <input type="text" name="withdrawal_amount" class="form-control" id="inputName" placeholder="Withdrawal Amount" @error('name') is-invalid @enderror"
                          value="{{ old('withdrawal_amount') }}" required>
                        </div>
                      </div>
                      <div class="form-group row">
